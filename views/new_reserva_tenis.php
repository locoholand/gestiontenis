<div class="container is-fluid mb-6">
    <h1 class="title">RESERVAR PISTA DE TENIS</h1>
...
<div class="container pb-6 pt-6">
    ...
    <form action="" method="POST" autocomplete="off" style="width: 30vw;">
        ...
        <div class="select is-warning">
            <select name="hora">
                <option value="<?php if (isset($_POST['hora'])) {
                 echo $_POST['hora'];}else echo '--Selecciona una hora--'
    ...
    if (isset($_POST['fecha']) && isset($_POST['hora'])) {
        ...
        if (
            $fecha == "" || $hora == "--Selecciona una hora--"
        ) {
        ...
        $pista = $conection->query("select * from pistas where tipo='Tenis' and activo=1");
    ...
    ?>
            <form class="FormularioAjax" action="./php/save_reserva.php" method="post">
                ...
                <input hidden class="input" name="hora" type="text" value="<?php if (isset($_POST['hora'])) {
                                                                                echo $_POST['hora'];
                                                                            } ?>" maxlength="40">
                <input hidden class="input" name="user_id" type="text" value="<?php echo $_SESSION['id'] ?>" maxlength="40">
                <select name="pistas">
                    <option>--Seleccione la pista que desea--</option>
                    <?php
